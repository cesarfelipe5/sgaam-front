import { LogoutOutlined, MenuOutlined } from "@ant-design/icons"; // Importando os ícones
...
const DrawerMenu = () => {
  ...
  return (
    ...
    >
      ...
      >
        <MenuOutlined
          style={{ marginRight: "10px", marginLeft: "15px", fontSize: "30px" }}
        />{" "}
        {/* Ícone de menu burger preto */}
      </button>
      {/* Logo da Academia */}
      <img
        src={logo}
        alt="Logo"
        style={{ height: "80px", marginRight: "10px", width: 90 }}
      />
      ...
      >
        ...
        >
          <MenuOutlined style={{ marginLeft: "20px", fontSize: 30 }} />{" "}
          {/* Ícone de menu burger branco */}
        </button>
